			...
			{isSignup ? (
				<form
					...
					<div className='text-alice pb-4 font-jetBrain'>
						...
						<p className='text-alice text-sm'>Create your account and start budgetting</p>
					</div>
					...
					<div className='grid grid-cols-1 gap-4'>
						<div className='border-t border-fluo'></div>
						<div className='grid grid-cols-2 gap-4'>
							<button className='flex justify-center items-center gap-4 bg-gray-900 py-2 px-2 rounded-lg border border-fluo hover:bg-gray-800/80'>
						...
						<div className='text-alice text-end font-jetBrain'>
							...
							<button onClick={toggleForms} className='text-fluo underline hover:text-fluo/70'>
								{" "}
								Login{" "}
							</button>
						</div>
